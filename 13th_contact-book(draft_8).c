...
struct data
{
    char name[100]; char surname[100]; int number; int day; int month; int year;
};
    ...
    while(i != 0)
    {
        ...
        switch(i)
        {
            case 1:
            {
                ...
                add_node_end(new_head, new_data);
                save_list_to_file(new_head, "list.bin");
                print_list(new_head);
                // free_data(new_head);
                break;
            }
            ...
            {   
                ...
                scanf("%s", surname);
                Node *new_head = load_list_from_file("list.bin");
                delete_node(&new_head, name, surname );
                save_list_to_file(new_head, "list.bin");
