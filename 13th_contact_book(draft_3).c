...
Node *sorted_merge( Node *a, Node *b, int i)
{
    ...
    switch(i)
    {
        case 1:
        {
            if (strcmp(a->data->name, b->data->name) == -1)
            {
                result = a;
        ...
        case 2:
        {
            if (strcmp(a->data->surname, b->data->surname) == -1 )
            {
                result = a;
                result->next = sorted_merge(a->next, b, i);
            }
        ...
        case 4:
        {
            if (a->data->year <= b->data->year || a->data->day <= b->data->day || a->data->month <= b->data->month )
            {
                result = a;
                result->next = sorted_merge(a->next, b, i);
            } 
