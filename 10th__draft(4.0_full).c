...
int test_mult() 
{
    ...
    for (int i = 0; i < 4; i++) 
    {
        if (fabs(out->A[i] - expected_result_data[i]) > 1.e-5) 
        {
            printf("Error: out->A[%d] == %lf; expected: out->A[%d] == %lf", i, out->A[i], i, expected_result_data[i]);
            return 1;
        }
    }
    destroy_matrix(M1);
            ...
            switch( 3 * i + j)
            {
                ...
                {   
                    ...
                    for (int k = 0; k < 4; k++) 
                    {
                        ...
                        {
                            printf("Error: 1) out->A[%d] == %lf; expected: out->A[%d] == %lf\n",
                ...
                case  1:
                {
                    ...
                    {   
                        ...
                        {
                            printf("Error: 2) out->A[%d] == %lf; expected: out->A[%d] == %lf\n",
                ...
                case 2:
                {
                    for (int k = 0; k < 4; k++) 
                    {
                        ...
                        {
                            printf("Error: 3) out->A[%d] == %lf; expected: out->A[%d] == %lf\n",
                ...
                case 3:
                {
                    for (int k = 0; k < 4; k++) 
                    {
                        ...
                        {
                            printf("Error: 4) out->A[%d] == %lf; expected: out->A[%d] == %lf\n",
                ...
                case 4:
                {
                    for (int k = 0; k < 4; k++) 
                    {
                        ...
                        {
                            printf("Error: 5) out->A[%d] == %lf; expected: out->A[%d] == %lf\n", 
                ...
                case 5:
                {
                    for (int k = 0; k < 4; k++) 
                    {
                        ...
                        {
                            printf("Error: 6) out->A[%d] == %lf; expected: out->A[%d] == %lf\n", 
                ...
                case 6:
                {
                    for (int k = 0; k < 4; k++) 
                    {
                        ...
                        {
                            printf("Error: 7) out->A[%d] == %lf; expected: out->A[%d] == %lf\n",
                ...
                case 7:
                {
                    for (int k = 0; k < 4; k++) 
                    {
                        ...
                        {
                            printf("Error: 8) out->A[%d] == %lf; expected: out->A[%d] == %lf\n", 
                ...
                case 8:
                {
                    for (int k = 0; k < 4; k++) 
                    {
                        ...
                        {
                            printf("Error: 9) out->A[%d] == %lf; expected: out->A[%d] == %lf\n",
...
int test_det() 
{
    ...
    {
        printf("Error: out == %lf; expected: out == %lf", out, expected_result_det);
        return 1;
    }
...
{
    double M1_data[4] = {1., 2., 3., 4.};
    double expected_result_data[4] = {-2., 1., 1.5, -0.5};
